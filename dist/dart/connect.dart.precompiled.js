...
main: function() {
  ...
  t1.forEach$1(t1, new K.main_closure());
  t1 = W._FrozenElementList$_wrap(document.querySelectorAll("input"), null);
  t1.forEach$1(t1, new K.main_closure0());
},
...
main_closure0: {"": "Closure;",
  call$1: function(e) {
    ...
    t1.get$onInput(e).listen$1(new K.main__closure(e));
    t1.get$onKeyUp(e).listen$1(new K.main__closure0(e));
  },
  $is_args1: true
},
