...
(function() {
  return namespace('Tok3nDashboard.Screens', function(exports) {
    ...
    exports.phonelineNew2 = function() {
      ...
      return phonelineOtpInput.addEventListener("input", limitToSixChar);
    };
    exports.destroyPhonelineNew2 = function() {
      phonelineOtpInput.removeEventListener('input', toggleNextButtonOtp);
      return phonelineOtpInput.removeEventListener("input", limitToSixChar);
    };
