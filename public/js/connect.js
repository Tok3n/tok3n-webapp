...
var WebFontConfig;
WebFontConfig = { google: { families: ['Arvo:400italic:latin'] } };
(function () {
  var s, wf;
...
Ladda.bind('.tok3n-submit button#tok3nLogin', { timeout: 5e3 });
Ladda.bind('.tok3n-submit button#tok3nOtpButton', { timeout: 5e3 });
